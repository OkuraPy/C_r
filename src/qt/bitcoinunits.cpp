...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("VBC");
    case mBTC: return QString("mVBC");
    case uBTC: return QString::fromUtf8("μVBC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("VibbeCoins"));
    case mBTC: return QString(QObject::tr("Milli-VibbeCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-VibbeCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
