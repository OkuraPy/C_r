...
DESCRIPTION="VibbeCoin - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/VibbeCoin-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "VibbeCoin" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/VibbeCoin-qt.protocol ${PN}.protocol
	fi
}
